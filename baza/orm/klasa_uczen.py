...
def main(args):
    ...
    kl3A.rokmatury = 2013
    kl3A.save()
    kl2A = Klasa(nazwa='2A', roknaboru=2009, rok matury= 2012)
    kl2A.save()
    ucz1 =Uczen(imie='Adam',nazwisko='stołowy', plec=False, klasa=kl3A)
    ucz1.save()
    ucz2 = Uczen(imie='Ewa',nazwisko='Duda', plec=True, klasa=kl2A)
    ucz2.save()   
    return 0
